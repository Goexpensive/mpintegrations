...
class Preferences(models.Model):
	...
	currency_id = models.CharField(max_length=254, null= True, blank=True)
	...
	auto_return =  models.URLField(null= True, blank=True)
	...
	expires = models.CharField(max_length=254, null= True, blank=True)
